...
/**
 * This is modified RandomData class from org.apache.avro:avro:1.12.0
 * Modified 147-152, 214-231 lines
 */
...
//      return generate(types.get(random.nextInt(types.size())), random, d);
      map = (Map<Object, Object>) genericData.newMap(null, 1);
      for (Schema type : types) {
        map.put(type.getNamespace() + "." + type.getName(), generate(type, random, d + 1));
      }
      return map;
